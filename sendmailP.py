...
ht+="<tr><th style='width:100px;height:35px'>#Build</th><th style='width:100px'>#Success</th><th style='width:100px'>#Fail</th><th style='width:100px;height:35px'>PassPercent</th><th>Deploy to ProdEnv</th></tr>"
while(total_builds):
    if count==10:
        break
